...
sys_env_destroy(envid_t envid)
{
  ...
  8000f5:	00 
  8000f6:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  8000fd:	00 
  8000fe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800105:	00 
  800106:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800165:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  ...
  80017b:	e8 51 00 00 00       	call   8001d1 <vcprintf>
	cprintf("\n");
  800180:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80020d:	e8 72 01 00 00       	call   800384 <vprintfmt>
	sys_cputs(b.buf, b.idx);
