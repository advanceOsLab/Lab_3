...
sys_env_destroy(envid_t envid)
{
  ...
  800102:	00 
  800103:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  80010a:	00 
  80010b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800112:	00 
  800113:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800172:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  ...
  800188:	e8 51 00 00 00       	call   8001de <vcprintf>
	cprintf("\n");
  80018d:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80021a:	e8 75 01 00 00       	call   800394 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800338:	0f be 80 fe 0e 80 00 	movsbl 0x800efe(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004db:	c7 44 24 08 16 0f 80 	movl   $0x800f16,0x8(%esp)
  8004e2:	00 
  ...
  8004fb:	c7 44 24 08 1f 0f 80 	movl   $0x800f1f,0x8(%esp)
  800502:	00 
  ...
  80052b:	b8 0f 0f 80 00       	mov    $0x800f0f,%eax
