...
libmain(int argc, char **argv)
{
  ...
  800056:	89 0d 00 20 80 00    	mov    %ecx,0x802000
	...
	umain(argc, argv);
  80005c:	89 54 24 04          	mov    %edx,0x4(%esp)
  800060:	89 04 24             	mov    %eax,(%esp)
  800063:	e8 cb ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  800068:	e8 02 00 00 00       	call   80006f <exit>
}
  80006d:	c9                   	leave  
  80006e:	c3                   	ret    
...
exit(void)
{
  ...
  800072:	83 ec 18             	sub    $0x18,%esp
	sys_env_destroy(0);
  800075:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80007c:	e8 3f 00 00 00       	call   8000c0 <sys_env_destroy>
}
  800081:	c9                   	leave  
  800082:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000ac:	b8 01 00 00 00       	mov    $0x1,%eax
  8000b1:	89 d1                	mov    %edx,%ecx
  8000b3:	89 d3                	mov    %edx,%ebx
  8000b5:	89 d7                	mov    %edx,%edi
  8000b7:	89 d6                	mov    %edx,%esi
...
sys_env_destroy(envid_t envid)
{
  ...
  8000ce:	b8 03 00 00 00       	mov    $0x3,%eax
  8000d3:	8b 55 08             	mov    0x8(%ebp),%edx
  8000d6:	89 cb                	mov    %ecx,%ebx
  8000d8:	89 cf                	mov    %ecx,%edi
  8000da:	89 ce                	mov    %ecx,%esi
  ...
  8000e0:	7e 28                	jle    80010a <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000e2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000e6:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8000ed:	00 
  8000ee:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  8000f5:	00 
  8000f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000fd:	00 
  8000fe:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800147:	8b 55 0c             	mov    0xc(%ebp),%edx
  80014a:	89 54 24 10          	mov    %edx,0x10(%esp)
  80014e:	8b 55 08             	mov    0x8(%ebp),%edx
  800151:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800155:	89 74 24 08          	mov    %esi,0x8(%esp)
  800159:	89 44 24 04          	mov    %eax,0x4(%esp)
  80015d:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  800164:	e8 c1 00 00 00       	call   80022a <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800169:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80016d:	8b 45 10             	mov    0x10(%ebp),%eax
  800170:	89 04 24             	mov    %eax,(%esp)
  800173:	e8 51 00 00 00       	call   8001c9 <vcprintf>
	cprintf("\n");
  800178:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
  80017f:	e8 a6 00 00 00       	call   80022a <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800184:	cc                   	int3   
  800185:	eb fd                	jmp    800184 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001b4:	e8 ca fe ff ff       	call   800083 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001fe:	c7 04 24 87 01 80 00 	movl   $0x800187,(%esp)
  800205:	e8 7a 01 00 00       	call   800384 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80021d:	e8 61 fe ff ff       	call   800083 <sys_cputs>
...
cprintf(const char *fmt, ...)
{
  ...
  80023d:	e8 87 ff ff ff       	call   8001c9 <vcprintf>
	va_end(ap);
