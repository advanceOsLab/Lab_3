...
exit(void)
{
  ...
  80007b:	e8 3f 00 00 00       	call   8000bf <sys_env_destroy>
}
  800080:	c9                   	leave  
  800081:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  8000df:	7e 28                	jle    800109 <sys_env_destroy+0x4a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8000e1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000e5:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8000ec:	00 
  8000ed:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  8000f4:	00 
  8000f5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000fc:	00 
  8000fd:	c7 04 24 c7 0e 80 00 	movl   $0x800ec7,(%esp)
  800104:	e8 27 00 00 00       	call   800130 <_panic>
...
sys_getenvid(void)
{
  ...
  80011c:	b8 02 00 00 00       	mov    $0x2,%eax
  800121:	89 d1                	mov    %edx,%ecx
  800123:	89 d3                	mov    %edx,%ebx
  800125:	89 d7                	mov    %edx,%edi
  800127:	89 d6                	mov    %edx,%esi
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800141:	e8 cb ff ff ff       	call   800111 <sys_getenvid>
  800146:	8b 55 0c             	mov    0xc(%ebp),%edx
  800149:	89 54 24 10          	mov    %edx,0x10(%esp)
  80014d:	8b 55 08             	mov    0x8(%ebp),%edx
  800150:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800154:	89 74 24 08          	mov    %esi,0x8(%esp)
  800158:	89 44 24 04          	mov    %eax,0x4(%esp)
  80015c:	c7 04 24 d8 0e 80 00 	movl   $0x800ed8,(%esp)
  800163:	e8 c1 00 00 00       	call   800229 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800168:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  80016c:	8b 45 10             	mov    0x10(%ebp),%eax
  80016f:	89 04 24             	mov    %eax,(%esp)
  800172:	e8 51 00 00 00       	call   8001c8 <vcprintf>
	cprintf("\n");
  800177:	c7 04 24 fc 0e 80 00 	movl   $0x800efc,(%esp)
  80017e:	e8 a6 00 00 00       	call   800229 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800183:	cc                   	int3   
  800184:	eb fd                	jmp    800183 <_panic+0x53>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001b3:	e8 ca fe ff ff       	call   800082 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001fd:	c7 04 24 86 01 80 00 	movl   $0x800186,(%esp)
  800204:	e8 7b 01 00 00       	call   800384 <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80021c:	e8 61 fe ff ff       	call   800082 <sys_cputs>
