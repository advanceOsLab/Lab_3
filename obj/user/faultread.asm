	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800238:	0f be 80 c8 0e 80 00 	movsbl 0x800ec8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003db:	c7 44 24 08 e0 0e 80 	movl   $0x800ee0,0x8(%esp)
  8003e2:	00 
  ...
  8003fb:	c7 44 24 08 e9 0e 80 	movl   $0x800ee9,0x8(%esp)
  800402:	00 
  ...
  80042b:	b8 d9 0e 80 00       	mov    $0x800ed9,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bf6:	e8 e0 f4 ff ff       	call   8000db <vcprintf>
	cprintf("\n");
  800bfb:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
